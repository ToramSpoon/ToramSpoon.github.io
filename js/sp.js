...
const extraSkillPoints = function () {
    ...
    totalPoints += $("#minigame-pr").prop("checked");
...
$(document).ready(() => {
    ...
    $("#stat-popup").on("click", function () {
        alert('Stat Points does not include the base default value of each stat, i.e. the initial 1.');
    });
